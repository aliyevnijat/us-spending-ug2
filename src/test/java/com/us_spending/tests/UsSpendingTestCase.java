...
>>>>>>> branch 'master' of https://github.com/aliyevnijat/us-spending-ug2.git
...
>>>>>>> branch 'master' of https://github.com/aliyevnijat/us-spending-ug2.git
	...
	public void testCase13() {
		...
		BrowserUtils.waitFor(2);
		assertTrue(hp.advancedSearch.isDisplayed());
	...
	public void testCase14() {
		...
		BrowserUtils.waitFor(2);
		assertTrue(hp.agencies.isDisplayed());
		assertTrue(hp.federalAcc.isDisplayed());
	}
	...
	public void testCase16() {
		...
		hp.glossary.click();
		BrowserUtils.waitFor(2);
		assertTrue(hp.glossarySearch.isDisplayed());
	}
